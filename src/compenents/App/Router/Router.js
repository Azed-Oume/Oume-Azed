...
const Conception = () =>{
    return(
        <>
        <h2 className="country__title">Concéption et realisation du site .</h2>
        <div className="section">
        <p className="country__content">Dans l'univers du développement web, ce site se dresse en tant qu'œuvre accomplie, entièrement conçue en React. Chaque fonctionnalité, chaque détail est le fruit de l'engagement passionné d'un jeune titulaire dans ce projet. À travers ces lignes de code, s'expriment expertise et créativité, portant en elles le potentiel et la détermination d'un développeur en herbe. Chaque clic, chaque interaction reflète un souci du détail et une vision technique propre à un futur expert du domaine. En toute modestie, cette réalisation est signée .</p>
        <p className="country__content">Oume-Azed</p>
        </div>
        </>
    )
}
...
const Blog = () => {
    return(
        <>
            <h2 className="country__title"> Bienvenue sur mon Blog </h2>
            
                
                <section className="section">
                    <div className="section">
                        <h3 className="country__title">Mon cv</h3>
                        <button type="submit" className="button">Voir mon cv "bientot dispo"</button>
                        <DocxViewer />
                    </div>
                    <div className="section__div ">
                        <article className="section__article motivation">
                            <h4 className="section__article__title">Formation Professionnel :</h4>
                             <a className="section__link__cv" href="https://1drv.ms/w/s!AleRy1V4c5HpomINf18YpxRI_TEO?e=dlQGS8"  target="_blank">Consulter la Formation professionnel</a>   
                        </article>
                        <article className="section__article motivation">
                            <h4 className="section__article__title">Experience Professionnel :</h4>
                            <a className="section__link__cv" href="https://1drv.ms/w/s!AleRy1V4c5HpomHV4-hmVTwBJS8f?e=ymydLM" target="_blank">Consulter l'éxperience Professionnel</a>
                        </article>
                        <article className="section__article motivation">
                            <h4 className="section__article__title">Lettre de motivation :</h4>
                            <a className="section__link__cv" href="https://1drv.ms/w/s!AleRy1V4c5HpokokMkTCTUfMiSnM?e=vWURX2" target="_blank">Lettre de motivation</a>
                        </article>
                    </div>
                </section>
...
const Cgu = () => {
    ...
    <>
        ...
        <h5 className="section__article__title">Utilisation Autorisée</h5>
        <p className="country__content">
        ...
        <h5 className="section__article__title">Comportement de l'Utilisateur</h5>
        <p className="country__content">
        ...
        <h5 className="section__article__title">Protection des Données Personnelles</h5>
        <p className="country__content">
        ...
        <h5 className="section__article__title">Modifications des CGU</h5>
        <p className="country__content">
        ...
        <h5 className="section__article__title">Résiliation</h5>
        <p className="country__content">
        ...
        <h5 className="section__article__title">Limitation de Responsabilité</h5>
        <p className="country__content">
        ...
        <h5 className="section__article__title">Juridiction</h5>
        <p className="country__content">
        ...
        <h5 className="section__article__title">Contact</h5>
        <p className="country__content">
            Pour toute question concernant les présentes CGU, veuillez nous contacter à auli-ondors@jaimel.com.
        </p>
        <p className="country__content">
            Dernière mise à jour : 27 aout 2023.
        </p>
