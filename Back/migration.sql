    -- Début de la transaction
     ...
     DROP TABLE IF EXISTS `ARTICLES_TAGS`,  `CATEGORIES`, `COMMANDE`,`FACTURE`,`PRODUIT`,`PRODUIT_COMMANDE`, `PRODUIT_DEVIS`, `ROLE`, `TAGS`, `MESSAGE`, `UTILISATEURS`, `ARTICLES`, `DEVIS`,`COMMENTAIRES`;
